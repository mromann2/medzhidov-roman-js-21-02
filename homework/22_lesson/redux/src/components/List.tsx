...
const connectHOC = connect(mapStateToProps, mapDispatchToProps); // Создание компонента высшего порядка, для обёртки нашего компонента
export const List = connectHOC(List1); // Обёртования нашего компонента в подключенный к стору компонент
